...
class VCurveFilter(VFuncFilter):
    ...
    def __init__(self, points, dtype=np.uint8):
        vFunc = utils.createCurveFunc(points)
        super(VCurveFilter, self).__init__(vFunc, dtype)
...
# Emulating Kodak Ektachrome
class BGREktachromeCurveFilter(BGRCurveFilter):
    """A filter that applies Ektachrome-like curves to BGR."""

    def __init__(self, dtype=np.uint8):
        BGRCurveFilter.__init__(
            self,
            bPoints=[(0, 0), (56, 22), (211, 255), (255, 255)],
            gPoints=[(0, 0), (56, 39), (208, 226), (255, 255)],
            rPoints=[(0, 20), (255, 235)],
            dtype=dtype)
