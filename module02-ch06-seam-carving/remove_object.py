...
# ============================================================
# Draw rectangle on top of the input image (mouse callback)
# ============================================================
...
# (forces seams to go through the selected ROI)
# ============================================================
def compute_energy_matrix_modified(img, rect_roi):
    ...
    # energy values in this region are set to 0 (lowest energy = preferred)
    energy_matrix[y:y + h, x:x + w] = 0
    return energy_matrix

# ============================================================
# Compute energy matrix (normal version)
# ============================================================
...
def remove_object(img, rect_roi):
    ...
    for i in range(num_seams):
        ...
        # Refresh window to avoid "Not Responding" freeze label
    ...
    for i in range(num_seams):
        ...
        print(f'Number of seams added = {i + 1}')
        # Refresh window
        cv2.imshow('Input', img_input)
        cv2.waitKey(1)
...
if __name__ == '__main__':
    # --- Fallback default if no argument given ---
    if len(sys.argv) < 2:
        print("[INFO] No image argument! Using default: img3.jpg")
    ...
    if img_input is None:
        print("=" * 50)
        print("ERROR: Cannot load image file:", image_path)
    ...
    print("[INFO] Click and drag with mouse to draw a rectangle around the object.")
    print("[INFO] Release mouse to remove the object.")
